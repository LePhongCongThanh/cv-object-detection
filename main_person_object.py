...
def process_video(video_path):
    ...
    detection_zone = [(400, 400), (600, 400), (600, 0), (400, 0)]
            ...
            if boxes.id is not None: # Ensure tracking IDs are present
                for box in boxes:
                    ...
                    if is_point_in_polygon(object_centroid, detection_zone):
                        ...
                        # If the object is a 'person' and in the zone, add its ID to the history
                        if class_name == "person":  # Only count 'person' class
                            unique_people_in_zone_history.add(track_id)
